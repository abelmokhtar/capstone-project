            ...
            <div class="container-fluid">
                ...
                <div class="row p-2">
                    	<div class="col-4" style="margin-right: 15px;">
                    			${message}
		                        <form action="createticket" method="post" style="background: #FFF !important; margin-right: 10px; padding: 40px 30px;">
			                            <div class="form-group">
			                              <input type="text" name="tickettitle" class="form-control" id="exampleFormControlInput1" placeholder="Ticket Title...">
			                            </div>
			                            <div class="form-group">
			                              <label for="exampleFormControlSelect1">Assign to a project</label>
			                              <select name="ticketproject" class="form-control" id="exampleFormControlSelect1">
			                                <option></option>
			                            ...
			                            <div class="form-group">
			                              ...
			                              <textarea name="ticketdescription" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
			                            </div>
			                            <div class="form-group">
			                            ...
			                            <div class="form-group">
			                                ...
			                                <select name="assignuser" class="form-control" id="exampleFormControlSelect1">
			                                  <option>Mike Doe</option>
			                                  <option>Carl Doe</option>
			                                  <option>Leo Risus</option>
			                                </select>
			                            </div>
			                            <div class="form-group pt-3">
			                                <input type="submit" class="btn btn-success" style="color: #FFF; float: right;" value="Create" />
			                            </div>
		                        </form>
                    	</div>
                    	<div class="col-6 p-3" style="background: #FFF; margin-right: 30px; padding: 30px !important;">
